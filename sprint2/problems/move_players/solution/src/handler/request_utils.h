...
struct reqApiV1 {
    ...
    constexpr static std::string_view gamePlayersAction {"/api/v1/game/players/action"sv};
...
struct errorJsonStr{
    ...
    constexpr static std::pair<std::string_view, std::string_view> invalidArgument{"invalidArgument"sv, "Failed to parse action"sv};
