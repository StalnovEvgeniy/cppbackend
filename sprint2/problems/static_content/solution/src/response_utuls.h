#ifndef MAPCONTEXTTIPE_H
#define MAPCONTEXTTIPE_H
...
FileResponse MakeFileResponse(http::status status, std::string_view filePath, unsigned http_version, bool keep_alive,
                              std::string_view contentType, sys::error_code& ec);

}


#endif // MAPCONTEXTTIPE_H
